...
class ViewController: UIViewController{
    ...
    private var city = City(latitude: "-23.6814346", longitude: "-46.9249599", name: "São Paulo")
    ...
    private func setConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            headerView.leadingAnchor.constraint(equalTo:
                view.safeAreaLayoutGuide.leadingAnchor, constant: 35),
            headerView.trailingAnchor.constraint(equalTo:
                view.safeAreaLayoutGuide.trailingAnchor, constant: -35),
